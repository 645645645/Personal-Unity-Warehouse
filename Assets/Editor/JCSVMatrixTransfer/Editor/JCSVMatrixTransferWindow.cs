...
/// <summary>
/// https://github.com/JTAOO/JCSVMatrixTransfer
/// </summary>
public class JCSVMatrixTransferWindow : EditorWindow
{
    ...
    [MenuItem("Tools/J CSV Matrix Transfer")]
    static void Open()
    {
    ...
    Vector3 worldMatrix_line0 = new Vector3(1, 0, 0);
    Vector3 worldMatrix_line1 = new Vector3(0, 1, 0);
    Vector3 worldMatrix_line2 = new Vector3(0, 0, 1);
    Vector3 worldMatrix_line3 = new Vector3(1, 1, 1);
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Box("使用这个工具， 利用世界空间转换矩阵设置Transform", richTextStyle_Mid, GUILayout.ExpandWidth(true));
        ...
        worldMatrix_line0 = EditorGUILayout.Vector3Field("unity_ObjectToWorld[0].xyz  (w = 0)", worldMatrix_line0);
        worldMatrix_line1 = EditorGUILayout.Vector3Field("unity_ObjectToWorld[1].xyz  (w = 0)", worldMatrix_line1);
        worldMatrix_line2 = EditorGUILayout.Vector3Field("unity_ObjectToWorld[2].xyz  (w = 0)", worldMatrix_line2);
        worldMatrix_line3 = EditorGUILayout.Vector3Field("unity_ObjectToWorld[3].xyz  (w = 1)", worldMatrix_line3);
    ...
    void Trans()
    {
        ...
        Vector4 line0 = AppendVector(worldMatrix_line0, 0);
        Vector4 line1 = AppendVector(worldMatrix_line1, 0);
        Vector4 line2 = AppendVector(worldMatrix_line2, 0);
        Vector4 line3 = AppendVector(worldMatrix_line3, 1);
    ...
    Vector4 AppendVector(Vector3 head, float end){
        return new Vector4(head.x, head.y, head.z, end);
    }
