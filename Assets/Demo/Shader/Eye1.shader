...
Shader "NN4/Eye1"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 texShadowOffset(float4 shadowcoordv, float4 v, float4 shadowcoordh, float4 h, float biasDepth)
            {
                float4 lightDepth;
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float3 shadowColr = sum * _NN4Char_LightColor1.xyz + i.v4.xyz; //v4 -> ambimet
